...
import { Service, Totals, ServiceStats, Resources, Recommendation, SelectedServiceUI, Category, ProjectObjective } from '../types';
...
const Planner: React.FC = () => {
  ...
  const relatedServicesSet = useMemo(() => {
     ...
     return set;
  }, [selectedObjectiveId, lastSelectedServiceId, objectives, data]);
  ...
  const recommendation = useMemo((): Recommendation | null => {
    ...
    return null;
  }, [selectedServicesMap, lastSelectedServiceId, totals.totalStats, dismissedRecs, data]);
  ...
  return (
    <div className="min-h-screen bg-white text-black p-6 md:p-12 lg:p-20 font-sans">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-4 relative">
          ...
          <div className="mt-8 text-center">
            <Link to="/admin" className="text-[10px] text-gray-300 hover:text-gray-500 uppercase tracking-widest">Admin Panel</Link>
          </div>
        </div>
